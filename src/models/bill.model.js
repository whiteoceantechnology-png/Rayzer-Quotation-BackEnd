...
BillItem.init(
  ...
  },
  {
    ...
    underscored: true,
    timestamps: false,
    indexes: [{ fields: ['bill_id'] }, { fields: ['product_id'] }],
  },
);
...
Bill.init(
  {
    ...
    discount_type: { type: Sequelize.INTEGER, allowNull: true },
    discount_value: { type: Sequelize.FLOAT, allowNull: true },
  ...
  },
  {
    ...
    underscored: true,
    indexes: [
      { unique: true, fields: ['bill_number'], name: 'bill_number' },
      { fields: ['customer_id'] },
      { fields: ['created_by'] },
      { fields: ['status'] },
      { fields: ['created_at'] },
